...
dw '                ====================================================',0ah,0dh
dw '               ||                                                  ||',0ah,0dh                                        
dw '               ||        *    Bubble Shooting Game      *          ||',0ah,0dh
dw '               ||                                                  ||',0ah,0dh
dw '               ||--------------------------------------------------||',0ah,0dh
dw '               ||                                                  ||',0ah,0dh
dw '               ||                                                  ||',0ah,0dh
...
main_loop:                                 ;update logic and display everything
    ...
    inside_loop:                           ;checking every thing
        ...
        cmp miss, 3                        ;if bubble miss 3 times.go to game over section
        jge game_over
        ...
        hit:                               ;play sound if hit
            ...
            jmp fire_loon                  ;new bubble pops up
    
        render_loon:                       ;draw bubble
            mov cl, ' '                    ;hide old bubble
            mov ch, 1111b
...
key_pressed:                              ;input handling section
    ...
    cmp ah,4Bh                            ;go leftKey (this is for debugging)
    je leftKey
     
                                          ;if no key is pressed go to inside of loop
    jmp inside_loop

leftKey:                                  ;we use it for debugging 
    ;jmp game_over
    inc miss
...
game_over:
    ...
    mov cl, ' '                           ;hide last of screen bubble
    mov ch, 1111b 
    mov bx,arrow_pos                      
...
;;                                                                    ;;
;;  Clear the screen                                                  ;;
;;  Just set new text mood for avoiding complexity                    ;;
;;                                                                    ;;
;;____________________________________________________________________;;
